...
<section id="data-list-view " class="data-list-view-header ">
    <div class="row match-height">
        <div class="col-md-12 col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control item" placeholder="Pilih type item">
                                            ...
                                            <option
                                                value="{{$item->id_item}} - {{$item->id_inbound_detail}} - {{$item->id_inventory_detail}}">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Detail Stock Count By Item</h4>
                </div>
                <hr>
                <div class="card-content">
                    <div class="card-body">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table tbl_list_item" id="tbl_list_item">
                                        <thead>
                                            <tr class="">
            ...
            else
            {
                $.ajax({
                    ...
                    data: {
                        'qty' :qty,
                        'id_locator' : id_locator,
                        'id_item' : object_item[0],
                        'idinbounddetail' : object_item[1],
                        'stock_count_by' : "item",
                        'idinventorydetail' : object_item[2]
                    },
                    dataType: "json",
                    success: function (response) {
                        let result = response;
