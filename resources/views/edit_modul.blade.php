...
<li class="breadcrumb-item active">Edit Modul
</li>
@endsection
        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form edit data modul</h4>
                </div>
                <hr>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_modul" class="form-control nama_modul"
                                            value="{{$modul->nama_modul}}" name="fname" placeholder="Nama Modul">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    function simpanData() {
        $.ajax({
            type: 'get',
            url: "{!! route('modul.update', $idmodul) !!}",
            headers: {
