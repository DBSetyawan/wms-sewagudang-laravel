...
<li class="breadcrumb-item"><a
        href="{{route('outbound.index', ['kodegudang'=>$kodegudang, 'kodeproject'=> $kodeproject])}}">Outbound</a>
</li>
<li class="breadcrumb-item active">Tambah Outbound
</li>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Buat Outbound</h4>
                </div>
                <hr>
                <div class="card-content">
                    <div class="card-body">
                        <form class="steps-wizard wizard-circle">
                                ...
                                <div class="outbound_header row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type='text' class="form-control required tanggal_outbound"
                                                placeholder="Tanggal Inbound" id="tanggal_outbound"
                                                name="tanggal_outbound" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control tujuan_outbound required" id="tujuan"
                                                name="tujuan" placeholder="Asal Inbound">
                                        </div>
                                    </div>
                            ...
                            <!-- Step 2 -->
                            <h6>Detail Outbound <b class="nooutbound_label"></b></h6>
                            <hr>
                            <fieldset>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <select name="" id="" class="form-control pilih_item"
                                                                    ...
                                                                    onchange="refreshTableItem()" value="">
            ...
            <div class="card">
                ...
                <div class="card-content tbl_format">
                    <div class="card-body">
                        <div class="1">
                            <div class="table-responsive ">
                                <table class="table nowrap tbl_detail_outbound" id="detail_outbound" width="100%">
                                    <thead>
                                        <tr class="th_detail_outbound">
                                            <th style="display:none">Id Item</th>
                                            <th>Kode Item</th>
...
<section id="form-and-scrolling-components">
    <div class="modal-size-md mr-1 mb-1 d-inline-block">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-1">
                                ...
                                <div class="input-group input-group-lg">
                                    <input type="text" class="quantity_available form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-12 mb-1">
                                <label>Quantity Pick</label>
                                <div class="input-group input-group-lg">
...
<script>
                ...
                if(response['status'] == 'success')
                {
                    let string = `
                        <tr>
                            ...
                            <td>${qty}</td>
                            <td>
                                <button type="button" class="btn btn-danger btn-icon btn-sm" onclick="removeItemFromDetailOutbound(${response.id_outbound_detail},${response.item[0]['id_inventory_detail']}, ${qty}, this)">
                ...
                if(sessionStorage.getItem('nooutbound') == null)
                {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $(".nooutbound_label").html(response);
    ...
    function removeItemFromDetailOutbound(argIdOutboundDetail ,argIdInventoryDetail, argQty, argObjectRow)
    {
    ...
    function openModal(argIdInventory, argIdLocator, argMaxLimit, argKodeItem, argIdInventoryDetail, argIdx)
    {
        ...
        $(".quantity_available").val(argMaxLimit);
        $(".quantity").focus();
    }
    ...
    function simpanOutbound()
    {
        ...
        let inbound_detail = $(".tbl_detail_outbound tbody tr").length;
