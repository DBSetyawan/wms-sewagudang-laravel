 ...
 *   https://datatables.net/download/#dt/dt-1.10.21/kt-2.5.2
 *
 * Included libraries:
 *  DataTables 1.10.21, KeyTable 2.5.2
 */
...
(function (f) {
    ...
    q.ext = C = {
        buttons: {},
        classes: {},
        builder: "dt/dt-1.10.21/kt-2.5.2",
        errMode: "alert",
        feature: [],
        search: [],
...
$jscomp.initSymbolIterator = function () {
    ...
    b ||
        (b = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol(
            "Symbol.iterator"
        ));
        ...
        _constructor: function () {
            ...
            if (this.c.editor) {
                ...
                if (this.c.editOnFocus)
                    c.on("key-focus" + e + " key-refocus" + e, function (
                        b,
                        c,
                        e,
                        d
