...
$mysqli = new mysqli('localhost', 'root', '', 'devsewagudangid');
...
$array = array(
    ...
    [18, 'Project Edit'],
    [19, 'Project Hapus'],
    [20, 'Project Template Inbound'],
    [21, 'Project Template Outbound'],
    [22, 'Project Metode Outbound'],
    [23, 'Item Add'],
    [24, 'Item Edit'],
    [25, 'Item Hapus'],
    [26, 'Inbound Add'],
    ...
    [29, 'Inbound Ceklist'],
    [30, 'Inbound Print'],
    [31, 'Inbound Upload POD'],
    [32, 'Inbound Download POD'],
    [33, 'Putaway'],
    [34, 'Outbound Add'],
    [35, 'Outbound Edit'],
    [36, 'Outbound Hapus'],
    ...
    [38, 'Outbound Loading'],
    [39, 'Outbound Print'],
    [40, 'Outbound Upload POD'],
    [41, 'Outbound Download POD'],
    [42, 'Stock Count'],
    [43, 'Report Inventory'],
    [44, 'Report Inbound'],
    [45, 'Report Outbound'],
    [46, 'Item Import'],
    [47, 'Outbound Cancel'],
    [48, 'Report Log Putaway'],
    [49, 'Project Duplicate Setup'],
    [50, 'Project Metode Inbound'],
    [51, 'Transfer'],
    [52, 'Report Quarantina'],
    [53, 'Report Balance']
);

// $array = array([1101010, 1101, ' Teupah Selatan'],
...
for ($i = 0; $i < count($array); $i++) {
    // $query = $mysqli->query('insert into tbl_modul(id_modul, nama_modul) values(' . $array[$i][0] . ", '" . $array[$i][1]  . "');");
    echo 'insert into tbl_modul(id_modul, nama_modul) values(' . $array[$i][0] . ", '" . $array[$i][1]  . "');";
}
